...
# NOTE: The code has been taken from: https://github.com/OpenGVLab/SAM-Med2D/blob/main/segment_anything/build_sam.py
# It has been refactored a bit in favor of readability and convenience of running the scripts.
...
def load_from(sam, state_dicts, image_size, vit_patch_size):
    ...
    new_state_dict = {
        k: v for k, v in state_dicts.items() if
    ...
    if pos_embed.shape[1] != token_size:
        ...
        def _check_condtion(k):
            val_list = ['2', '5', '7', '8', '11', '13', '15', '23', '31']
            _condtion = [val in k for val in val_list]
            return any(_condtion)

        global_rel_pos_keys = [k for k in rel_pos_keys if _check_condtion(k)]
        # print(sam_dict)
