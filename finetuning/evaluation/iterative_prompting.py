...
def _run_iterative_prompting(dataset_name, exp_folder, predictor, start_with_box_prompt, use_masks):
    ...
    return prediction_root, semantic_class_maps


def _evaluate_iterative_prompting(
    dataset_name, prediction_root, start_with_box_prompt, exp_folder, semantic_class_maps
):
...
def main():
    ...
    prediction_root, semantic_class_maps = _run_iterative_prompting(
