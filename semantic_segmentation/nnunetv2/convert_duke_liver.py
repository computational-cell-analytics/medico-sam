...
def convert_duke_liver_for_testing(path, trg_dir, dataset_name):
    test_image_paths, test_gt_paths = _get_paths(path, "duke_liver", "test")
...
def main():
    ...
    convert_duke_liver_for_testing(path=path, trg_dir=trg_root, dataset_name=dataset_name)
