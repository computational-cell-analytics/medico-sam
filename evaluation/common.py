# NOTE: this needs to be copied here so that the model checkpoint can be loaded.
# It would be better to refactor this into the medico_sam module, so that we don't need to copy over the code!
